...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body:isLoading ==true ?AppLoader(): ListView(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Header("${allTranslations.text("confirmed_order_number")}",
                    data.data.confirmedOrderNumber, "num"),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          orderLayer(Icons.person,
                              data.data.orders[index].userName ?? " كريم طه"),
                          Row(
                            children: [
                              ...
                              orderLayer(
                                  Icons.timer, data.data.orders[index].time),
                            ],
                          ),
                          Row(
                            children: [
                              ...
                              Text("${data.data.orders[index].paymentStatus} "),
                            ],
                          ),
                          Row(
                            children: [
                              ...
                              Text("${data.data.orders[index].locationType} "),
                            ],
                          ),
                          Text(
